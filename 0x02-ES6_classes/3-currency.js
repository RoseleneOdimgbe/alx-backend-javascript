...
export default class Currency {
  ...
  /**
   * This sets the currency name
   * @param {string} value - This is the new currency name
   */
  set name(value) {
  ...
  /**
   * This displays the full currency information
