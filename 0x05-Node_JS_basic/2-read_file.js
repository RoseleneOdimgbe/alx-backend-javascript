...
/**
 * This reads a CSV file, converts it to JSON, and logs the number of students
 * and their information based on specified fields
 *
 * The function synchronously reads the CSV file from the given path,
 ...
 *
 * @param {string} path - This is the path to the CSV file containing student data
