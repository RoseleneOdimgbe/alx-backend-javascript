...
/**
 * This counts the number of students from a database file and logs student
 ...
 *
 * @param {string} path - This is the file system path to the database file that
 ...
 * @throws {Error} This throws an error if the database file cannot be read or
